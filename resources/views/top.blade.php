...
@section('scripts')
  ...
  <script>
    window.top_tracks_short_data = {!! json_encode($top_tracks_short) !!};
    window.top_tracks_medium_data = {!! json_encode($top_tracks_medium) !!};
    window.top_tracks_long_data = {!! json_encode($top_tracks_long) !!};
